...
export default function Navbar({ currentView, onChangeView, variant = 'landing' }: NavbarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-50 bg-indigo-950/95 backdrop-blur-md border-b border-indigo-900/80 shadow-md">
          ...
          <div className="hidden sm:flex items-center gap-2.5">
            {currentView !== 'login' && currentView !== 'app' && (
              <button
                ...
                className="text-xs font-bold text-white px-3.5 py-1.5 hover:bg-white/5 rounded-lg transition cursor-pointer"
              >
                Sign In
              </button>
            )}
